...
import sys
sys.path.append("../")
from agents.common.common_ddpg import DDPG_interface
...
class GreedyDDPG(DDPG_interface):
    def __init__(
            self,
            user_num=1000,
            init_roi=10.,
        ...
        super(GreedyDDPG, self).__init__(user_num=user_num, action_dim=action_dim, action_bound=action_bound,
                                         n_features=n_features, init_roi=init_roi, budget=budget,
...
if __name__ == "__main__":
    ...
    update_times_per_train = 10
    agent = GreedyDDPG(user_num=user_num, action_dim=1, action_bound=20, n_features=61, init_roi=init_cpr_thr,
                       budget=budget,
                       use_budget_control=use_budget_control,
