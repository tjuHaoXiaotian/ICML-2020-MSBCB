...
import sys
sys.path.append("../")
from agents.common.common_cpr import ROIDQN_interface
from simulation_env.multiuser_env import run_env, eval_env, MultiUserEnv
import argparse
os.environ['CUDA_VISIBLE_DEVICES'] = '-1'


class GreedyMaxCPR(ROIDQN_interface):
    def __init__(
            self,
            user_num=1000,
            n_actions=2,
        ...
        super(GreedyMaxCPR, self).__init__(user_num, n_actions, n_features, init_roi, budget,
...
if __name__ == "__main__":
    ...
    if train:
        ...
        eval_env(agent,
                 "./result/step-01/MSBCB/train/1000_user/action_n=2/per=0/seed=1/1578987377/best_model/model-1000",
